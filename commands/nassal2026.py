...
NASSAL_FIRST_STAGE_FOUND_TEXT = """📝 <b>Этап II</b>
...
NASSAL_FIRST_STAGE_NOT_FOUND_TEXT = """⚠️ <b>Этап II</b>
...
Твоя работа для <b>Этапа II</b> принята и передана администраторам."""

NASSAL_FIRST_STAGE_ALREADY_EXISTS_TEXT = """📝 <b>Этап II</b>
...
async def start_stage_submission(
    ...
    chat = update.effective_chat
    msg = update.effective_message
    stage_label = "Финала" if stage_kind == "final" else "Этапа II"
