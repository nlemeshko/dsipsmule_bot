...
NASSAL_FIRST_STAGE_FOUND_TEXT = """📝 <b>IV Этап</b>
...
NASSAL_FIRST_STAGE_NOT_FOUND_TEXT = """⚠️ <b>IV Этап</b>
...
Твоя работа для <b>IV Этапа</b> принята и передана администраторам."""

NASSAL_FIRST_STAGE_ALREADY_EXISTS_TEXT = """📝 <b>IV Этап</b>
...
async def start_first_stage_submission(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Запускает отправку работы для IV Этапа."""
...
async def start_stage_submission(
    ...
    chat = update.effective_chat
    msg = update.effective_message
    stage_label = "Финала" if stage_kind == "final" else "IV Этапа"
